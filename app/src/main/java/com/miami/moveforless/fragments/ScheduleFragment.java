...
public class ScheduleFragment extends BaseFragment implements View.OnClickListener {
    ...
    private boolean generatedData() {
        ...
        jobModel.from_address = "from some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
        jobModel.to_address = "to some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
        jobModel.from_city = "From some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
        jobModel.to_city = "To some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
        ...
        for (int i = 0; i < 2; i++) {
            ...
            jobModelToday.from_address = "from some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
            jobModelToday.to_address = "to some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
            jobModelToday.from_city = "From some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
            jobModelToday.to_city = "To some Cityssssssssssssssssssssssssssssssssssssssssssssssssssssss";
